...
import type { JenisKantor } from "@/types/admin/master/jenis-kantor";
import { Textarea } from "@/components/ui/textarea";

// Definisikan tipe props yang lebih spesifik untuk form ini
interface JenisKantorFormProps {
  form: Partial<JenisKantor>;
  setForm: (data: Partial<JenisKantor>) => void;
  onCancel: () => void;
  onSubmit: () => void;
  readonly?: boolean;
  isLoading?: boolean;
...
export default function JenisKantorForm({
  form,
  setForm,
  onCancel,
  onSubmit,
